...
namespace PrintThempActiveX
{
    ...
    public static class EditEventReferences
    {
        ...
        public delegate void ActiveEditControlList(FrmEditFrm editfrom, EditActiveTypeInfo activetype);
        /// <summary>
        /// 该委托用来封装编辑模板所对应的鹰眼切换
        /// </summary>
        /// <param name="editfrom">FrmEditfrom(注:编辑模板实例)</param>
        public delegate void ActiveEditEagleLook(FrmEditFrm editfrom);
        /// <summary>
